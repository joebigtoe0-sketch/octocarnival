...
export const SLOT_DEFS = [
  {
    ...
    tiers: {
      ...
      legendary: { variants: ['Honker Hair', 'A1lon hair'], coinValue: 11300 },
  ...
  },
  {
    ...
    tiers: {
      ...
      legendary: { variants: ['Red Alert', 'Bagged', 'White shades of A1lon'], coinValue: 11400 },
  ...
  },
  {
    ...
    tiers: {
      ...
      legendary: { variants: ['Riot Gear', 'Poor beater'], coinValue: 11800 },
  ...
  },
  {
    ...
    tiers: {
      ...
      legendary: { variants: ['Cloud Nine', 'Pill rider'], coinValue: 12200 },
